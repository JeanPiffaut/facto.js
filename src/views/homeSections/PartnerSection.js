    ...
    <section className={"py-5"}>
        <div className="container">
            ...
            <div className="row">
                ...
                <PartnerLink src={pymes_en_linea} alt={"Pymes en Línea"} to={"https://pymesenlinea.cl/alianza/full-digitalizacion-para-tu-negocio-automatiza-todo-tu-proceso-de-venta-y-facturacion-con-30-de-descuento-exclusivo"} height={"67"} />
                ...
                <div className="col-12 col-sm-6 mb-3 mb-lg-0">
                    <Link className="bg-body-secondary border-0 card h-100" to={"./facto-en-la-prensa"}>
                        <div className="card-body d-flex justify-content-center align-items-center">
                            <ImageSEO defaultSrc={logo_mer} placeholderSrc={logo_mer} alt={"logo_mer"} width={"auto"} height={"16"} sources={[]} loading="lazy" />
                        </div>
                    </Link>
                </div>
                <div className="col-12 col-sm-6">
                    <Link className="bg-body-secondary border-0 card h-100" to={"https://www.df.cl/df-lab/innovacion-y-startups/como-una-startup-chilena-asesoro-a-la-reserva-federal-para-crear-sistema#:~:text=Facto%2C%20una%20startup%20chilena%20fundada,estandarizar%20el%20sistema%20de%20ese"} target={"_blank"}>
                        <div className="card-body d-flex justify-content-center align-items-center">
                            <ImageSEO defaultSrc={diario_fin} placeholderSrc={diario_fin} alt={"diario_fin"} width={"auto"} height={"16"} sources={[]} loading="lazy" />
                        </div>
                    </Link>
                </div>
            </div>
            ...
            <div className="row">
                <PartnerLink src={logo_sii} alt={"SII"} to={"https://www.sii.cl/servicios_online/1039-emp_prov_fe-1184.html"} width={"150"} />
                <PartnerLink src={logo_corfo} alt={"Corfo"} to={"https://corfo.cl/sites/cpp/homecorfo"} width={"150"} />
                <PartnerLink src={logo_previred} alt={"Previred"} to={"https://www.previred.com/web/previred/softwares-gratuito"} width={"200"} />
            </div>
        </div>
    </section>
));