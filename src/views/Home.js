        ...
        <div className="container">
            <div className="bg-light border-0 card shadow">
                <div className="card-body py-5">
                    <h2 className="text-center fw-semibold">
                        Un sistema de ventas, administración y facturación<br /> que permite <b className={"text-success"}>gestionar
                        tu negocio</b>
                    </h2>
                    <div className="row pt-5">
                        <div className="col-12 col-lg-4 text-center">
                            <ImageSEO defaultSrc={banner_pc_doc} placeholderSrc={banner_pc_doc} sources={[]} alt={"Aumenta tus ingresos"} height={"60"} width={"76"} loading="lazy" />
                        ...
                        <div className="col-12 col-lg-4 text-center">
                            <ImageSEO defaultSrc={banner_bag} placeholderSrc={banner_bag} sources={[]} alt={"Ahorra tiempo"} height={"60"} width={"76"} loading="lazy" />
                            <p className={"h4 fw-semibold mt-2"}>
                                Ahorra <br />
                                tiempo
                            </p>
                        ...
                        <div className="col-12 col-lg-4 text-center">
                            <ImageSEO defaultSrc={banner_pc_phone} placeholderSrc={banner_pc_phone} sources={[]} alt={"Úsalo en cualquier dispositivo"} height={"60"} width={"76"} loading="lazy" />
                            <p className={"h4 fw-semibold mt-2"}>
                                Úsalo en <br />
            ...
            <div className="row">
                <div className="col-12 col-lg-6 text-center mb-5 mb-lg-0">
                    <ImageSEO defaultSrc={people_use} placeholderSrc={people_use} sources={[]} alt={"Diseño completo de funcionalidades para PYMEs y emprendedores"} width={"auto"} height={"auto"} loading="lazy" />
                </div>
                <div className="align-items-center col-12 col-lg-6 d-flex text-center">
                    <div>
                        ...
                        <p className={"h4 fw-semibold"}>Con un completo sistema de facturación en tu tienda física y online.</p>
                        <p className={"fs-7"}>
                            Si estás recién formalizando tu negocio o necesitas más orden y gestión administrativa para tu empresa ¡FACTO es para ti!
                        </p>
                        <div className={""}>
            ...
            <div className="row">
                ...
                <div className="row py-5">
                    <IntegrationLink src={woocommerce} alt={"Woocommerce"} to={"./producto/integracion-facto-woocommerce/"} width={"140"} />
                    <IntegrationLink src={jump_seller} alt={"Jumpseller"} to={"./producto/integracion-facto-jumpseller/"} width={"140"} />
                    <IntegrationLink src={services} alt={"Servicios Integrados"} to={"./producto/integracion-facto-api/"} width={"155"} />
                    <IntegrationLink src={service_api} alt={"Servicios API"} to={"./complementos/servicios-integrados/"} width={"109"} />
                </div>
                <div className="d-flex justify-content-center justify-content-lg-evenly align-items-center">
                    <p className="txt-contents p-2 fs-7 m-0" style={{ maxWidth: "372px" }}>
                        Tus ventas online están sincronizadas con nuestro sistema, tu inventario, stock, facturas y demás con el orden que necesitas en tiempo real.
                    </p>
